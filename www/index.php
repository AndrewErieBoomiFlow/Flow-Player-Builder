		...
		<form action="generate.php" method="post">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="form-group" >
						<label for="player_favicon">Nav Logo Image Link</label>
						<input type="text" class="form-control" id="player_favicon" placeholder="" name="player_navlogo">
					</div>
					<div class="form-group">
					...
					<div class="col-md-3">
						<div class="form-group checkbox">
							<label><input data-toggle="toggle" type="checkbox" value="true" name="player_iscolab">Is Colaboration</label>
						</div>
					</div>					
			...
			<div id="toggle-advanced" style="display:none">
				...
				<!-- Custom Components -->
				<div class="panel panel-default big-labels">
					<div class="panel-heading">
						<h3 class="panel-title">Custom Components (Work in progress, not generating)</h3>
					</div>
					<div class="panel-body">
						
						<div class="form-group checkbox">
							<label><input data-toggle="toggle" type="checkbox" value="true" name="custom_fileinput"><strong> File Input to Base64 String</strong> [<a target="_blank" href="https://github.com/AndrewErieBoomiFlow/manywho-fileinput">View Project</a>]</label>
						</div>
						
						<hr class="hr-sm">	
						<div class="form-group checkbox">
							<label><input data-toggle="toggle" type="checkbox" value="true" name="custom_signature"><strong> Signature Pad</strong> [<a target="_blank" href="https://github.com/manywho/ui-signature-pad">View Project</a>]</label>
						</div>
			...
			<center><button type="submit" class="btn-lg btn-primary" style="border:none">Generate Your Player</button></center>
			
			<center>
				<br><br><br><br>
				<div class="checkbox">
					<label><input data-toggle="toggle" type="checkbox" id="toggle_adv" value="true" name="settings_advanced" onclick="toggle_advanced();">Enable Advanced Settings</label>
				</div>
			</center>
